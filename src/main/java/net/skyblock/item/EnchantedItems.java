...
public class EnchantedItems {
    public static final Item ENCHANTED_ACACIA_LOG = registerItem("enchanted_acacia_log", new EnchantedItem(new FabricItemSettings().rarity(Rarity.UNCOMMON)));
    public static final Item ENCHANTED_BAKED_POTATO = registerItem("enchanted_baked_potato", new EnchantedItem(new FabricItemSettings().rarity(Rarity.RARE)));
    public static final Item ENCHANTED_POTATO = registerItem("enchanted_potato", new EnchantedItem(new FabricItemSettings().rarity(Rarity.UNCOMMON)));
    ...
    public static final Item CACTUS = registerItem("enchanted_cactus",
            new EnchantedItem(new FabricItemSettings().rarity(Rarity.RARE)));
    public static final Item CACTUS_GREEN = registerItem("enchanted_cactus_green",
            new EnchantedItem(new FabricItemSettings().rarity(Rarity.UNCOMMON)));
